...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_signed_ints_and_floats(self):
        ...
        self.assertEqual(max_integer([10, -10, 10.5]), 10.5)
        self.assertEqual(max_integer([{1, 9}, {2}, {3}]), {1, 9})

    def test_list_of_strings(self):
        self.assertEqual(max_integer("6789"), '9')
        self.assertEqual(max_integer("abcxyp"), 'y')
        self.assertEqual(max_integer(['a', 'b', 'c', 'x', 'p', 'q']), 'x')
        self.assertEqual(max_integer(["abc", 'h']), 'h')
